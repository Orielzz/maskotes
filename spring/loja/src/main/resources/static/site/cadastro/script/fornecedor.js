function preparaJson() {
    ...
    const formFields = document.querySelectorAll('#fornecedorForm input');
...
const url = "http://192.168.1.229:8080/fornecedor";
...
document.getElementById("fornecedorForm").addEventListener('submit', function (event) {
    ...
    .then(data => {
        ...
        document.getElementById("fornecedorForm").reset(); // Limpa o formulário
    })
    .catch(error => {
